...
extern void test_devito_stencil_kernel(float** stencil, int steps, int step, int iterations, int size, float* result, struct profiler*);
extern void test_openblas_stencil_kernel(int steps, int step, int iterations,  int size);
extern void test_custom_stencil_kernel(float** stencil, int steps, int step, int iterations,  int size, float* result,struct profiler*);
#endif